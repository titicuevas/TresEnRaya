...
def coordenada(literal, inferior, superior):
    while True:
        ...
        print(
            "El valor indicado es incorrecto,introduzca un numero entre {0} y {1}".format(inferior, superior))


def colocarFicha(ficha):
    print("Dame la posicion de una ficha")
    while True:
        fila =coordenada("Fila entre [1-3]: ", 1, 3) - 1  # Restamos 1 para que sea de 0-2
        columna =coordenada("Columna entre [1-3]: ", 1, 3) - 1  # Restamos 1 para que sea de 0-2
